...
The purpose of this tutorial is to teach you how to use a regex to correctly identify strings that contain email addresses. 

## Summary

There are many different parts of the regex syntax that can be confusing. Throughout the course of the tutorial I will explain in detail each part of the email regex. This tutorial will focus on the regex syntax for the JavaScript langauge.
...
A husband and father that loves to code!!!
[https://github.com/hickscj24](https://github.com/hickscj24)
